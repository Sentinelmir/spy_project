...
const words = {
  places: [
        ...
        "Винодельня", "Спортзал", "Пекарня", "Больница", "Порт", "Фабрика", "Гора", "Озеро", "Дворец", "Пещера", "Сыроварня", "Голубятня"
    ],
    hobbies: [
        ...
        "Пение на сцене", "Видеомонтаж", "Гейминг", "Фридайвинг", "Вышивание бисером", "Реставрация мебели", "Пение в парке", "Коллекционирование марок", "Оригами", "Караоке", "Хоббихорсинг"
    ],
    food: [
